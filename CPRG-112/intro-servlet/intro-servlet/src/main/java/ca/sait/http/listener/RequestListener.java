...
public class RequestListener implements ServletRequestListener {/*, ServletRequestAttributeListener {*/
     ...
     */
    @Override // scope only in the request
    public void requestInitialized(ServletRequestEvent sre) {
        logger.trace("ENTER requestInitialized(sre)");
        // set database stuff here, don't know url here. so cast to HttpServletRequest, then know the resource. in theory, won't do it, just a practice here.
