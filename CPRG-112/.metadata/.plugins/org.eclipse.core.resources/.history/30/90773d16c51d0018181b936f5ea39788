      ...
      <div class="panel-body">
        ...
        <form id="register-form" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="firstName" id="firstName" placeholder="First Name" value="${model.person.firstName}"  />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="lastName" id="lastName" placeholder="Last Name" value="${model.person.lastName}"  />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="${model.person.email}"  />
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="control-label col-sm-4" for="password">Password:</label>
            <div class="col-sm-8">
              <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="${model.person.password}"  />
            </div>
          </div>
