...
public class Person extends AbstractEntity {
    ...
    @NotNull
    @Size(min=1, max=35, message="Must be between 1 and 35 chars")
    ...
    @NotNull
    @Size(min=1, max=128, message="Must be between 1 and 128 chars")
    @Column(name = "email", length = 128, nullable = false, unique = true, updatable=false)
    private String email;
    
    // length = 16; not nullable
    @NotNull
    @Size(min=1, max=16, message="Must be between 1 and 16 chars")
