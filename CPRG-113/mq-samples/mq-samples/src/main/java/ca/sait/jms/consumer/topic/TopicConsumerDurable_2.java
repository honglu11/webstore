 ...
 *
 */
public class TopicConsumerDurable_2
implements HasLogger {
    ...
    public static void main(String[] args) {
        new TopicConsumerDurable_2().run();
    } 
    ...
    private void run() {
        ...
        try (final JMSContext jmsContext = MQConnectionFactory.newContext();) {
            jmsContext.setClientID("client-1a");
            
            final Topic destTopic = jmsContext.createTopic("sait.ONE");
            
            try(final JMSConsumer consumer = 
                    jmsContext.createDurableConsumer(destTopic, "consumer-1a", "colour='red'", false)) {
                ...
                consumer.setMessageListener(new MessageListener() {
                    ...
                    public void onMessage(Message message) {
                        try {
                            ...
                            logger().info("Topic Durable ({}) - {}", colour, message.getBody(String.class));
