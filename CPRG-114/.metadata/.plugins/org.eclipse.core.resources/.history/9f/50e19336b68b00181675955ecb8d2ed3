                ...
                try {
                    ...
                    if ( qty <= cartSession.getIndividualProduct(productOid).getInventoryQuantity()) {
                      cartSession.addItem(productOid, qty);
                        ...
                        setErrorMessage("The product " + cartSession.getIndividualProduct(productOid).getName()  + " you order " + quantity + " is overseed the stock quntity " + cartSession.getIndividualProduct(productOid).getInventoryQuantity().toString()); 
                    }
