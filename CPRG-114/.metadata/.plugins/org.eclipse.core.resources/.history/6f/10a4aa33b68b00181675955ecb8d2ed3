...
@Generated(value="Dali", date="2018-05-01T19:10:47.393-0600")
...
public class PersonEntity_ extends AbstractEntity_ {
	...
	public static volatile SingularAttribute<PersonEntity, String> password;
	public static volatile SingularAttribute<PersonEntity, Date> birthdate;
	public static volatile ListAttribute<PersonEntity, RoleEntity> roles;
}
