...
public final class ShoppingCartDAO extends AbstractDAO<ShoppingCartEntity> implements HasLogger  {
    ...
    public ShoppingCart convert(ShoppingCartEntity entity) {
        ...
        Person customer = new Person(entity.getCustomer().getOid(),entity.getCustomer().getFirstName(), entity.getCustomer().getLastName(),
                    entity.getCustomer().getEmail(), entity.getCustomer().getPassword(), entity.getCustomer().getBirthdate());
