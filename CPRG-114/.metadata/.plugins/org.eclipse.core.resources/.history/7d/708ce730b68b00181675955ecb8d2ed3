...
public class PersonsModel extends AbstractModel {
    ...
    private void delete(HttpServletRequest request) {
        ...
        if (request.getParameter("oid") != null) {
            ...
            setErrorMessage("Oid is empty, must select a person oid for delete");
        }
        ...
        try {
            ...
            personService.removePerson(UUID.fromString(oid));
 
        } catch (NoEntityFoundException e) {
            setErrorMessage("Cannot delete none exsit person: " + e);
        }
        setSuccessMessage("Delete this person successfully");
        }
